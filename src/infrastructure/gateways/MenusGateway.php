...
/**
 * Gateway HTTP pour le microservice "menus".
 *
 */
class MenusGateway implements MenusInterface
{
     ...
     * @param string $baseUrl Base URL du microservice (ex: http://localhost:3004).
     * @param int $timeout Timeout (secondes) appliqué aux requêtes.
     */
